...
public class BillDetail
{
    ...
    public ICollection<BillBtDetail> BtDetails { get; set; } = new List<BillBtDetail>();
    public ICollection<BillGst> GstDetails { get; set; } = new List<BillGst>();
    public ICollection<BillEcsNeftDetail> EcsDetails { get; set; } = new List<BillEcsNeftDetail>();
    public ICollection<DdoAllotmentBookedBill> AllotmentDetails { get; set; } = new List<DdoAllotmentBookedBill>();
    public ICollection<BillSubvoucher> Subvouchers { get; set; } = new List<BillSubvoucher>();
}
